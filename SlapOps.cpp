...
void InitSlabOps()
{
    Programs.Advect = CreateProgram("./Shader/Fluid.Vertex", 0, "./Shader/Fluid.Advect");
    Programs.Jacobi = CreateProgram("./Shader/Fluid.Vertex", 0, "./Shader/Fluid.Jacobi");
    Programs.SubtractGradient = CreateProgram("./Shader/Fluid.Vertex", 0, "./Shader/Fluid.SubtractGradient");
    Programs.ComputeDivergence = CreateProgram("./Shader/Fluid.Vertex", 0, "./Shader/Fluid.ComputeDivergence");
    Programs.ApplyImpulse = CreateProgram("./Shader/Fluid.Vertex", 0, "./Shader/Fluid.Splat");
    Programs.ApplyBuoyancy = CreateProgram("./Shader/Fluid.Vertex", 0, "./Shader/Fluid.Buoyancy");
}
